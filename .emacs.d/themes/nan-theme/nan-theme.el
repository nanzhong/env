...
(let ((default "#efefef")
      ...
      (background-red "#6B2B2B")
      (bright-background-red "#aa3939")
      (background-purple "#48384c")
      (background-blue "#0f454f")
      (bright-background-blue "#437983")
      (background-green "#536528")
      (bright-background-green "#4c5b28")
      (background-orange "#a75b00")
      (hl-line "#39393d")
      (grey "#cccccc")
      (grey-dark "#666666")
      (highlight "#313131")
      ...
      (green-light "#c8f25f")
      (peach "PeachPuff3")
      (diff-added-background "#4c5b28")
      (diff-added-refined-background "#778359")
      (diff-removed-background "#583333")
      (diff-removed-refined-background "#b33c49")
      (diff-current-background "#29457b")
      (diff-current-refined-background "#1db4d0"))
  ...
  (custom-theme-set-faces
   ...
   `(whitespace-trailing ((t (:background ,red :foreground ,background :weight bold
					  :inverse-video nil))))
   `(whitespace-line ((t (:background unspecified :foreground ,bright-background-red
				      :inverse-video unspecified))))
